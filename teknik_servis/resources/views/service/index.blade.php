                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="search-service-id" name="search-service-id"
                                placeholder="Servis Numarası Giriniz..">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label class="form-label"><b>Müşteri Adı Soyadı:</b></label>
                            <input type="text" class="form-control" id="search-service-fullname"
                                name="search-service-fullname" placeholder="Müşteri Ad Soyad Giriniz...">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="search-service-phone" name="search-service-phone"
                                placeholder="Cep Telefon Numarası Giriniz...">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="search-service-imei" name="search-service-imei"
                                placeholder="Cihaz İmei Numarasını Giriniz..">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label class="form-label"><b>Ürün Modeli:</b></label>
                            <select class="form-select" id="search-service-product-id" name="search-service-product-id"
                                aria-label="Seçiniz..">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="search-service-product-status-id"
                                name="search-service-product-status-id" aria-label="Seçiniz..">
                                <option>Seçiniz...</option>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="search-service-referance-id" name="search-service-referance-id"
                                aria-label="Seçiniz..">
                                <option>Seçiniz...</option>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <div class="input-group mb-3">
                                <input type="date" class="form-control" id="search-service-start-date"
                                    name="search-service-start-date" aria-describedby="basic-addon1">
                                <input type="date" class="form-control" id="search-service-end-date"
                                    name="search-service-end-date" aria-describedby="basic-addon1">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <button type="button" id="filterServiceButton" class="btn btn-warning float-end">Sonuçları Detaylı
                            Filtrele</button>
                    </div>
                </div>
            </form>
            ...
            let table = new DataTable('#myTable', {
                ...
                ajax: {
                    ...
                    data: function(d) {
                        ...
                        d.search_service_product_status_id = $('#search-service-product-status-id')
                        .val();
